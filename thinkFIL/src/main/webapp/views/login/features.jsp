...
<!-- Full Page Intro -->
		...
		<section class="my-5" style="margin:10%;">

			<!-- Section heading -->
			<h2 class="h1-responsive font-weight-bold text-center my-5">Why
				is it so great?</h2>
			<!-- Section description -->
			<p class="lead grey-text text-center w-responsive mx-auto mb-5">Lorem
			...
			<div class="row">
				...
				<div class="col-md-4">
					...
					<div class="row mb-3">
						...
						<!-- Grid column -->
						<div class="col-2">
							<i class="fa fa-2x fa-flag-checkered deep-purple-text material-icons"></i>
						</div>
						<!-- Grid column -->
					...
					<div class="row mb-md-0 mb-3">
						...
						<div class="col-10">
							...
							<p class="grey-text mb-md-0">Lorem ipsum dolor sit amet,
								consectetur adipisicing elit. Reprehenderit maiores nam, aperiam
